local assets =
{
    ...
    Asset("ATLAS", "images/inventoryimages/lambcrown_arms_picaxe.xml"),
    Asset("IMAGE", "images/inventoryimages/lambcrown_arms_picaxe.tex"),	
}
...
local function onequip(inst, owner)
    owner.AnimState:OverrideSymbol("swap_object", "swap_lambcrown_arms", "swap_lambcrown_picaxe")
...
local function fn()
    ...
    inst.AnimState:SetBank("lambcrown_arms_picaxe")
    inst.AnimState:SetBuild("lambcrown_arms_picaxe")
    ...
    inst.components.inventoryitem.imagename = "lambcrown_arms_picaxe"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/lambcrown_arms_picaxe.xml"
...
return Prefab("lambcrown_arms_picaxe", fn, assets)