local assets =
{
    ...
    Asset("ATLAS", "images/inventoryimages/lambcrown_arms_fishingrod.xml"),
    Asset("IMAGE", "images/inventoryimages/lambcrown_arms_fishingrod.tex"),	
}
...
local function onequip(inst, owner)
    owner.AnimState:OverrideSymbol("swap_object", "swap_lambcrown_arms", "swap_lambcrown_fishingrod")
...
local function fn()
    ...
    inst.AnimState:SetBank("lambcrown_arms_fishingrod")
    inst.AnimState:SetBuild("lambcrown_arms_fishingrod")
    ...
    inst.components.inventoryitem.imagename = "lambcrown_arms_fishingrod"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/lambcrown_arms_fishingrod.xml"
...
return Prefab("lambcrown_arms_fishingrod", fn, assets)